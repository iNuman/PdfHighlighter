...
//				picker.pick();
    ...
    public boolean copySelection() {
        ...
        if (text.length() == 0)
            return false;
        Log.i("TEXTSHAPE", "copySelection: in this method ");
    ...
    /*markup selection called for highlight,strike, underline */
    @SuppressLint("StaticFieldLeak")
    public boolean markupSelection(final Annotation.Type type) {
        Log.i("TEXTHIGHLIGHT", "markupSelection: in start ");
        ...
        processSelectedText(new TextProcessor() {
            ...
            public void onEndLine() {
                if (!rect.isEmpty()) {
                    Log.i("TEXTHIGHLIGHT", "onEndLine:--RectCheck");
        ...
        if (quadPoints.size() == 0) {
            Log.i("TEXTHIGHLIGHT", "markupSelection: size zero");
            return false;
        }
...
/*    public void undoDraw() {
        Log.e("MODIFICATION", "undoDraw: ");
    }*/

  /*  public void redoDraw() {
        Log.e("MODIFICATION", "redoDraw: ");
    }*/
/*save draw and cancel draw method change  */
    @SuppressLint("StaticFieldLeak")
...
//		};
        ...
        //already comment mAddInk.execute(getDraw());
        //  by me mAddInk.execute(getDraw(), getColor(), getInkThickness());
    ...
    private void loadAnnotations() {
        Log.i("TEXTHIGHLIGHT", "loadAnnotations: in start ");
        mAnnotations = null;
        ...
        mLoadAnnotations = new AsyncTask<Void, Void, Annotation[]>() {
            ...
            protected Annotation[] doInBackground(Void... params) {
                Log.i("TEXTHIGHLIGHT", "loadAnnotations: doInBackground");
                return mCore.getAnnoations(mPageNumber);
            }

            @Override
            protected void onPostExecute(Annotation[] result) {
                Log.i("TEXTHIGHLIGHT", "loadAnnotations: doInBackground"+result);
                mAnnotations = result;
            }
        };
    ...
    @Override
    public void setPageMode(String nightDayTheme) {
        dayNight = nightDayTheme;
        update();

    }

    @Override
    public void setContinuousPageScroll(Boolean continueScroll) {
        continueScrolling = continueScroll;
    }
